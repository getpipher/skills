...
Arguments: [--apply] [--dry-run] [--backup] [--config FILE]
...
📂 docs/ (new Divio structure - 18 files)
  ...
  └── 📁 reference/ (4 files) - Information-oriented
      ...
      ├── commands.md          ← MOVE: ./dotfiles/agent/COMMANDS.md
      └── ...
...
Generated by: the workspace-organize-docs skill
...
workspace-organize-docs --generate-config divio
workspace-organize-docs --generate-config microsoft
workspace-organize-docs --generate-config api-first
...
✅ **Complements `workspace-planning-sync`:**
- `workspace-planning-sync` detects scattered docs → suggests `workspace-organize-docs`
- `workspace-organize-docs` fixes organization → keeps planning docs synced
...
workspace-organize-docs

# Dry run with specific config
workspace-organize-docs --config .docs-organize.yml

# Generate configuration template
workspace-organize-docs --generate-config divio

# Apply reorganization (with confirmation)
workspace-organize-docs --apply

# Apply with backup (recommended)
workspace-organize-docs --apply --backup

# Apply without backup (use with caution)
workspace-organize-docs --apply --no-backup

# Try different structure type
workspace-organize-docs --structure microsoft --dry-run

# Export report without applying
workspace-organize-docs --export docs-plan.md
```
